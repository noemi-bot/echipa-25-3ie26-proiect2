    ...
    <div className="max-w-7xl mx-auto py-20 px-4 animate-fade-in font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {proiecte.map((proiect, index) => (
          <div key={index} className="bg-card border border-border p-10 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 group">
            ...
            <div className="flex flex-wrap gap-2">
              {proiect.tehnologii.map((tech, idx) => (
